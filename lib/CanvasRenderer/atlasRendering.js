...
CanvasRenderer.prototype._renderAtlas = function (graphicCanvasses, graphicDims) {
	...
	atlas.width  = this._powerOf2Images? nextHighestPowerOfTwo(atlasDim.width)  : atlasDim.width;
	atlas.height = this._powerOf2Images? nextHighestPowerOfTwo(atlasDim.height) : atlasDim.height;
