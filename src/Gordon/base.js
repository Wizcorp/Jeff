...
var Base = {
	...
	spriteTags: [0, 1, 4, 5, 15, 18, 19, 26, 28, 43, 45, 70],
	tagNames: {},
	tagHandlers: {},
	fillStyleTypes: {
		SOLID: 0x00,
	...
	placeFlags: {
		...
		//flags below are for PlaceObject3 and newer
		HAS_OPAQUE_BACKGROUND: 0x40,
		HAS_VISIBLE: 0x20,
		HAS_IMAGE: 0x10,
		HAS_CLASS_NAME: 0x08,
...
(function () {
	function upper(match, p1, p2) { return p2.toUpperCase(); }
	var t = Base.tagCodes,
		n = Base.tagNames,
		h = Base.tagHandlers;
	for (var name in t) {
		var code = t[name];
		n[code] = name;
		h[code] = '_handle' + name.toLowerCase().replace(/(^|_)([a-z])/g, upper);
	}
})();
